...
(function () {
  ...
  function bindVSL() {
    ...
    function showToggle() {
      ...
      hideTimer = setTimeout(function(){ toggle.classList.remove('show'); }, 1500);
    }
    ...
    video.addEventListener('play',  function(){ toggle.classList.remove('paused'); showToggle(); });
    video.addEventListener('pause', function(){ toggle.classList.add('paused'); toggle.classList.add('show'); clearTimeout(hideTimer); });
